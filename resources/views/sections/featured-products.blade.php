    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
        <a href="/product/beija-flor" class="group animate-fade-up-delay-1">
            <img
                ...
                alt="Beija Flor"
                class="w-full rounded-xl transition duration-300 group-hover:scale-105">
        ...
        <a href="/product/el-mirador" class="group animate-fade-up-delay-1">
            <img
                ...
                alt="El Mirador"
                class="w-full rounded-xl transition duration-300 group-hover:scale-105">
            <h3 class="mt-4 text-xl font-semibold">El Mirador</h3>
            <p class="font-bold mt-1">$7.50</p>
            <div class="mt-4 flex justify-between text-sm">
                <span class="font-semibold">Tasting Notes:</span>
        ...
        <a href="/product/pedra-branca" class="group animate-fade-up-delay-1">
            <img
                ...
                alt="Pedra Branca"
                class="w-full rounded-xl transition duration-300 group-hover:scale-105">
            <h3 class="mt-4 text-xl font-semibold">Pedra Branca</h3>
            <p class="font-bold mt-1">$4.10</p>
            <div class="mt-4 flex justify-between text-sm">
                <span class="font-semibold">Tasting Notes:</span>
                <span class="text-right text-gray-700">Red Apple, Walnut, Milk Chocolate</span>
            </div>
        </a>
    </div>
</section>